...
// Returns the private 'App\Repository\FilmsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FilmsRepository.php';

return $this->privates['App\Repository\FilmsRepository'] = new \App\Repository\FilmsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
