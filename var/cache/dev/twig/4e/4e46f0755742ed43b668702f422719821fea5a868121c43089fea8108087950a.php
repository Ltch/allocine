...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" class=\"help-text\"><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, array(), \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/Applications/MAMP/htdocs/allocine/my-project/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
