...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\FavorisRepository' => function () {
    return ($this->privates['App\Repository\FavorisRepository'] ?? $this->load('getFavorisRepositoryService.php'));
}, 'App\\Repository\\FilmsRepository' => function () {
    return ($this->privates['App\Repository\FilmsRepository'] ?? $this->load('getFilmsRepositoryService.php'));
}, 'App\\Repository\\LoginRepository' => function () {
    return ($this->privates['App\Repository\LoginRepository'] ?? $this->load('getLoginRepositoryService.php'));
